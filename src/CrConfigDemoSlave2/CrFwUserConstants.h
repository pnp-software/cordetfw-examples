 ...
 * Header file to define all user-configurable constants and types for the Slave 1
...
/** The identifier of the Slave 2 Application of the CORDET Demo */
#define CR_FW_HOST_APP_ID 3
