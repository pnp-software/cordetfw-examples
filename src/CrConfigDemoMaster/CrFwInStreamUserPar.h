 ...
 * CORDET Framework.
 *
 * The Master Application receives packets from the two Slave Applications.
...
#define CR_FW_INSTREAM_SHUTDOWNACTION {&CrDaClientSocketShutdownAction, \
									   &CrDaClientSocketShutdownAction}
