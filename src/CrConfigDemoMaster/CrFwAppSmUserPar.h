 ...
 * Parameters for the Application State Machine (see <code>CrFwAppSm.h</code>) for the
 * Master Application of the CORDET Demo.
 *
...
#ifndef CRMA_APPSM_USERPAR_H_
#define CRMA_APPSM_USERPAR_H_
